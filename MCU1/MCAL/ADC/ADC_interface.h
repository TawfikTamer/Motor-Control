...
void ADC_Init                     ( void                                                                             );
u8   ADC_GetResultSync            ( u8 Copy_u8Channel , u16* Copy_pu16Result                                         );
u8   ADC_StartConversionAsynch    ( u8 Copy_u8Channel , u16* Copy_pu16Reading , void(*Copy_pvNotificationFunc)(void) );
...
u8 ADC_SetPrescaler (u8 Copy_u8Prescaler);
